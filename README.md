...
## Requirements
The instance in entirely local so you can deploy this application alongside a fresh database to your machine. This keeps your client's data safe so you can maintain ethical practices, but does require a little bit of setup. 

You will need to install [Ollama](https://ollama.com/) and [Neo4J](https://neo4j.com/docs/operations-manual/current/installation/) community edition on your machine. Both are very straightforward installs, and be found at the relevent websites. We used llama3 for all our tests!
